...
class Component(ApplicationSession):
    ...
    @asyncio.coroutine
    def rainbow(self, badge_id, runtime=5000, speed=64, intensity=128, offset=32):
    ...
    def onJoin(self, details):
        ...
        yield from self.subscribe(self.rainbow, u'me.magbadge.badge.rainbow')
        ...
        while True:
            try:
                ...
                if msg_type == STATUS_UPDATE:
                    ...
                    if not gpio_trigger:
                        yield from self.set_lights_one(badge_id, 0, 0, 0)
